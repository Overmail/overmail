...
test("a locked share is metadata at most, and says a password is needed", async () => {
    answering(200, {needs_password: true, metadata: {...OPEN.metadata, labels: null}, content: null});
...
test("a share that hides everything is nothing but the question", async () => {
    answering(200, {needs_password: true, metadata: null, content: null});
