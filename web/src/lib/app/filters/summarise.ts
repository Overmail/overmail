/**
 * What a filter chip says about what it is on: the first few by name, and how many are left over.
 *
 ...
 * with the selection.
 */
export function summarisePicked(names: string[], shown = 2): {shown: string[]; rest: number} {
