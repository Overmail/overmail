<script lang="ts" module>
	...
	export const sidebarMenuButtonVariants = tv({
		...
		variants: {
			...
			size: {
				default: "h-9 text-sm group-data-[compact=true]/sidebar-root:h-7",
				sm: "h-8 text-xs group-data-[compact=true]/sidebar-root:h-6",
				lg: "h-14 px-3 text-sm group-data-[collapsible=icon]:p-0! group-data-[compact=true]/sidebar-root:h-11",
			},
		},
		defaultVariants: {
			variant: "default",
